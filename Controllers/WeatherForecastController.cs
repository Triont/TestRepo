            ...
            switch(type)
            {
                case 0:
                    for (int i = 0; i < ps.Count; i++)
                    {
                        ...
                        loopVarFirst.Item1 = ps[i].Item4.AddYears(-2);
                ...
                case 1:
                    for (int i = 0; i < ps.Count; i++)
                    {
                        ...
                        loopVarFirst.Item1 = ps[i].Item4.AddYears(-6);
                        loopVarFirst.Item2 = ps[i].Item1;
                        temp_value.Add(loopVarFirst);
                        ValueTuple<DateTime, double> loopVarSecond = (DateTime.MinValue, 0);
                        loopVarSecond.Item1 = ps[i].Item4;
            ...
            switch(type)
            {
                case 0:
                    for (int i = 0; i < ps.Count; i++)
                    {
                        ...
                        if (!result.Contains((ps[i].Item1, ps[i].Item3, ps[i].Item4.AddYears(-2))))
                        {
                            result.Add((ps[i].Item1, ps[i].Item3, ps[i].Item4.AddYears(-2)));
                        }
                ...
                case 1:
                    ...
                    for (int i = 0; i < ps.Count; i++)
                    {
                        ...
                        if (!result.Contains((ps[i].Item1, ps[i].Item3, ps[i].Item4.AddYears(-6))))
                        {
                            result.Add((ps[i].Item1, ps[i].Item3, ps[i].Item4.AddYears(-6)));
                        }
